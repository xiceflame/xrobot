...
@PreTrainedConfig.register_subclass("xr1_stage1") # custom decorator to register as a subclass of PreTrainedConfig to be found by the xr1_stage1 identifier
@dataclass # simplify class initialization, no need to manually initialize
class Xr1Stage1Config(PreTrainedConfig):
    ...
    n_obs_steps: int = 2 # single input image
