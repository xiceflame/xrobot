...
python lerobot/scripts/visualize_dataset.py \
    ...
    --save 1 \
    --output-dir output/
# output down load xxx.rrd
open web: https://rerun.io/viewer

python lerobot/scripts/visualize_dataset.py \
    --repo-id 241223_upright_cup \
    --root /media/data/lerobot/lerobot_franka_3rgb/241223_upright_cup \
    --local-files-only 1 \
    --episode-index 0 \
    --save 1 \
    --output-dir output/
python lerobot/scripts/visualize_dataset.py \
    --repo-id test \
    --root /media/data/lerobot/lerobot_ur/test \
    --local-files-only 1 \
    --episode-index 0 \
    --save 1 \
    --output-dir output/
